...
var app = {
    ...
    bindEvents: function() {
        ...
        document.addEventListener('conectar', this.windowChange, false);
        document.getElementById("conectar").addEventListener("click", function(){
            window.location = "conectar.html";
        });
        document.addEventListener('bluetooth', this.windowbluetooth, false);
    ...
    onDeviceReady: function() {
        ...
        app.receivedEvent('conectar');
        app.receivedEvent('bluetooth');
    },
